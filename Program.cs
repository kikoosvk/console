    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {   // Open the text file using a stream reader.
                ...
                using (StreamReader sr = new StreamReader("./data/bupa/bupa_fuzzy_drinks_0_6.json"))

                {
                    ...
                    {
                        Console.WriteLine(i);
                        var alg01 = new Algorithm(0, 0.6);
                        alg01.init(table);
                        var validation01 = new TenCrossValidation();
                        var matrix01 = validation01.Validate02(2, table, alg01);
                        if(matrix01 != null) {
                            sens += matrix01.Sensitivity();
                            spec += matrix01.Specificity();
                            replications ++;
                        }
                    }

                    Console.WriteLine("replications>: "+replications);
                    Console.WriteLine("Sensitivity: "+sens/replications);
                    Console.WriteLine("Specificity: "+spec/replications);
                    Console.WriteLine("Kriteria: "+((sens/replications) + (spec/replications) ) / 2);
                    ...
                    // var alg03 = new Algorithm03(0.1, 0.7, 0.9);
